...
import { Clock, ArrowRight, Fish, Waves, Music, Sprout, Shell, Leaf } from "lucide-react";
            ...
            <section className="py-24 px-6 lg:px-12 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">À propos de Niafrang</h2>
                            <p className="text-lg text-slate-600 mb-6">
                                Le village de Niafrang se situe au nord-ouest du département de Bignona dans la commune de
                                Kataba 1 dont l’arrondissement porte le même nom. Le village de Niafrang abrite un des sites où le
                                zircon a été découvert sur la dune il y a quelques décennies. A l’ouest, se trouve l’écosystème de la
                                mangrove ensuite, les bolongs, la plage, l’océan et à l’Est se situent les périmètres rizicoles.
                                <br />

                            </p>
                            <p className="text-lg text-slate-600 mb-6">Le village de Niafrang est créé il y a environ 150 ans. Le premier habitant du village s’appelait Bacary
                                COLY. Il est venu du village de Karantaba. Selon les sources villageoises, avant Karantaba, il
                                a séjourné au niveau des villages de Karone, Tendouck, Thiobon et Koudiouké. Cette longue
                                pérégrination est la cause de l’ignorance de ses origines familiales. Les gardiens de la tradition au
                                sein de la communauté ne sont pas en mesure de dresser l’arbre généalogique du premier habitant
                                du village de Niafrang.
                            </p>
                        </div>
                        <div>
                            <Image
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        ...
                        <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                            Partagez le quotidien des habitants de Niafrang et découvrez la richesse de leur culture à travers des expériences uniques au cœur de la Casamance.
                        </p>
                    </div>
